...
$(document).ready(function (){
	...
	// ação para desativar os botões ao clicar na ordenação
	...
	//ação do botão editar(abir modal)
	...
	//submit do formulario edit modal
	...
	//alterar a imagem no componente <img> no modal
